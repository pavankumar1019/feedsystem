			...
			<form method="post" id="add_name">
				...
				<div class="modal-body">
					<div class="form-group">
		      			<input type="text" name="name" id="name" class="form-control" placeholder="Enter Course" />
		      		</div>
					<div class="form-group">
					<input type="number" name="sem" id="sem" class="form-control" placeholder="Enter Sem" />
		      		</div>
				</div>
